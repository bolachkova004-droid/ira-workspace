...
3. Workflow связывает проект, применяет обе миграции, сохраняет серверные секреты, разворачивает шесть функций, настраивает Telegram webhook и пяти-минутный cron.
